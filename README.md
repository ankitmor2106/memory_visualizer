...
**Live Demo →** [Frontend on GitHub Pages](https://ankitmor2106.github.io/memory_visualizer/frontend/index.html) &nbsp;|&nbsp; **API →** [Backend on Render](https://memory-visualizer.onrender.com)
